        ...
        public bool Init()
        {
            ...
            { 
                ...
                {     
                    ...
                    if (!DoesWin32MethodExist("kernel32.dll", "SetDllDirectoryW")) throw new PlatformNotSupportedException("Yubukey support requires Windows XP Service Pack 1 or greater");
